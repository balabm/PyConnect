...
/// Pump multiple times to allow async providers to resolve.
Future<void> _pumpSettled(WidgetTester tester, {int times = 20}) async {
  for (int i = 0; i < times; i++) {
    await tester.pump(_pumpDuration);
  }
}

/// Suppress layout overflow errors that come from the FoodScreen's
/// internal bottom sheet layout (pre-existing UI bug, not test-related).
