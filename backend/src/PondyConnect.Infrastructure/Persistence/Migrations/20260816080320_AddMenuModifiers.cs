        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_driver_wallets_drivers_DriverId1",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WalletId1 = table.Column<Guid>(type: "uuid", nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamptz", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_driver_wallet_transactions_driver_wallets_WalletId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_driver_wallet_transactions_WalletId1",
                table: "driver_wallet_transactions",
                column: "WalletId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_driver_wallets_DriverId1",
                table: "driver_wallets",
                column: "DriverId1");
